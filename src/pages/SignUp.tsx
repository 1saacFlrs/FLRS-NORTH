    ...
    <div className="max-w-md mx-auto mt-24 px-8 w-full text-white min-h-[60vh]">
      <div className="bg-zinc-900/50 p-8 border border-zinc-800 shadow-xl">
        ...
        <form onSubmit={handleSignUp} className="space-y-4">
          ...
          <Button type="submit" disabled={isLoading || isGoogleLoading} className="w-full rounded-none tracking-widest uppercase bg-white text-black hover:bg-zinc-200 mt-6">
